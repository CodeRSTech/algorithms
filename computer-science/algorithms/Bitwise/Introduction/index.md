...
| Operator                               | Example                                                                 | Python Examples                                                                              |
|----------------------------------------|-------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|
| AND<br><small>Conjunction</small>      | $A \land B$ <small>or</small><br>$A \cdot B$                            | `A & B` <small>*(bitwise)*</small><br> `A and B`<small>*(logical)*</small><br>               |
| OR <br><small>Disjunction </small>     | $A \lor B$ <small>or</small><br>$A + B$                                 | `A | B` <small>*(bitwise)*</small><br>`A or B` <small>*(logical)*</small><br>                |
| NOT <br><small>Negation </small>       | $\neg A$ <small>or</small><br>$\overline{A}$ <small>or</small><br>$A'$  | `~ A` <small>*(bitwise)*</small><br>`not A` <small>*(logical)*</small><br>                   |
| NAND <br><small>Inverted AND </small>  | $\overline{A \land B}$ <small>or</small><br>$\overline{A \cdot B}$      | `~ (A & B)` <small>*(bitwise)*</small><br>`not (A and B)` <small>*(logical)*</small><br>     |
| NOR <br><small>Inverted OR</small>     | $\overline{A \lor B}$ <small>or</small><br>$\overline{A + B}$           | `~ (A | B)`  <small>*(bitwise)*</small><br>`not (A or B)` <small>*(logical)*</small><br>     |
| XOR <br><small>Exclusive OR </small>   | $A \oplus B$                                                            | `A ^ B`  <small>*(bitwise)*</small><br> `A != B` <small>*(logical inequality)*</small><br>   |
| XNOR <br><small>Exclusive NOR </small> | $A \odot B$ <small>or</small><br>$\overline{A \oplus B}$                | `~ (A ^ B)`  <small>*(bitwise)*</small><br> `A == B` <small>*(logical equality)*</small><br> |
