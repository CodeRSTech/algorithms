...
`topological ordering` of a [DAG](https://en.wikipedia.org/wiki/Directed_acyclic_graph) is a linear ordering of vertices such that:
...
no directed cycles $\iff$ $G$ is a [**DAG**](# "Directed Acyclic Graph"). 
